        ...
        <>
            ...
            <div className="flex flex-col items-center">
                <button
                    ...
                    className={`w-full ${getButtonColor(streamActive, "green")} text-white font-semibold py-3 px-6 rounded-lg mt-4 transition duration-200 bg-green`}
                >
                ...
                <button
                    ...
                    className={`w-full ${getButtonColor(detectionActive, "blue")} text-white font-semibold py-3 px-6 rounded-lg mt-4 transition duration-200`}
